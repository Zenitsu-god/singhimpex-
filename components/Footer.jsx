...
//             title: "CONTACT",
//             links: [
//                 { text: "+91-9376270131", path: '/', icon: MailIcon },
//                 { text: "infosinghimpex@gmail.com", path: '/', icon: PhoneIcon },
//                 { text: "Shop No.2, Jai Bhawani Colony,\nMarudhar Vihar,Khatipura,\nJaipur, Rajasthan 302012", path: '/', icon: MapPinIcon }
//             ]
//         }
//     ];
...
//                             <span className="text-green-600">Singh</span>Impex<span className="text-green-600 text-5xl leading-0"></span>
//                         </Link>
//                         <p className="max-w-[410px] mt-6 text-sm">Welcome to Singh Impex, your reliable source for premium industrial and construction products. We provide quality materials, competitive prices, and dependable service to meet the needs of businesses and customers across the market.</p>
...
//                                             {link.icon && <link.icon />}
//                                             <Link href={link.path} className="hover:underline transition"><span className="whitespace-pre-line">{link.text}</span></Link>
//                                         </li>
//                                     ))}
//                                 </ul>
//                             </div>
...
//                     Copyright 2026 © SinghImpex All Right Reserved.
//                 </p>
//             </div>
//         </footer>
//     );
...
const Footer = () => {
    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Leather Bags", path: "/shop" },
                { text: "Wallets", path: "/shop" },
                { text: "Belts", path: "/shop" },
                { text: "Travel Bags", path: "/shop" },
            ]
        },
        {
            title: "QUICK LINKS",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91-9376270131", path: "tel:+919376270131", icon: PhoneIcon },
                { text: "infosinghimpex@gmail.com", path: "mailto:infosinghimpex@gmail.com", icon: MailIcon },
                {
                    text: "Shop No.2, Jai Bhawani Colony,Marudhar Vihar,\nKhatipura,Jaipur,\n Rajasthan 302012",
                    path: "#",
                    icon: MapPinIcon
                },
            ]
    ...
    return (
        <footer className="mx-6 mt-24 bg-stone-50 rounded-t-3xl">

            <div className="max-w-7xl mx-auto">

                <div className="flex flex-col lg:flex-row justify-between gap-14 py-14 border-b border-amber-200">
                    ...
                    <div className="max-w-md">
                        ...
                        <Link href="/" className="flex flex-col leading-tight">
                            ...
                            <span className="text-xs tracking-[0.2em] uppercase text-slate-500 mt-1">
                                Premium Leather Goods
                            </span>
                        </Link>

                        <p className="mt-6 text-slate-600 leading-7">
                            Singh Impex brings together premium craftsmanship and timeless
                            design through a curated collection of genuine leather bags,
                            wallets, belts and accessories. Every product is created with
                            quality, durability and elegance in mind.
                        </p>
                        ...
                        <div className="flex gap-3 mt-8">
                            ...
                            {socialIcons.map((item, index) => (
                                <Link
                                    key={index}
                                    href={item.link}
                                    className="w-11 h-11 rounded-full bg-white border border-amber-200 flex items-center justify-center hover:bg-amber-700 hover:text-white hover:border-amber-700 transition"
                                >
                                    <item.icon />
                                </Link>
                            ))}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-10">
                        ...
                        {linkSections.map((section, index) => (
                            ...
                            <div key={index}>
                                ...
                                <h3 className="text-slate-800 font-semibold mb-5 tracking-wide">
                                    {section.title}
                                </h3>
                                ...
                                <ul className="space-y-4 text-slate-600">
                                    ...
                                    {section.links.map((link, i) => (
                                        ...
                                        <li key={i} className="flex items-start gap-2">
                                            ...
                                            <Link
                                                href={link.path}
                                                className="hover:text-amber-700 transition whitespace-pre-line"
                                            >
                                                {link.text}
                                            </Link>
                ...
                <div className="py-6 flex flex-col md:flex-row justify-between items-center text-sm text-slate-500">
                    ...
                    <p>
                        © 2026 Singh Impex. All rights reserved.
                    </p>

                    <p className="mt-3 md:mt-0">
                        Crafted with Quality • Built for Everyday Elegance
                    </p>
